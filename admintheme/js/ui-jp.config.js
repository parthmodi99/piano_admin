...
var jp_config = {
  ...
  wysiwyg:        [   '/admintheme/libs/jquery/bootstrap-wysiwyg/bootstrap-wysiwyg.js',
                      '/admintheme/libs/jquery/bootstrap-wysiwyg/external/jquery.hotkeys.js'],
  dataTable:      [   '/admintheme/libs/jquery/datatables/media/js/jquery.dataTables.min.js',
                      '/admintheme/libs/jquery/plugins/integration/bootstrap/3/dataTables.bootstrap.js',
                      '/admintheme/libs/jquery/plugins/integration/bootstrap/3/dataTables.bootstrap.css'],
