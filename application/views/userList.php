      ...
      <tbody>
          ...
          <?php if(!empty($user)) : $i=1;foreach($user as $row) : ?>
            ...
            <td>
              ...
              <td>
                  <?= (!empty($row['pro_at']))? $row['pro_at'] :'-' ?>
              </td>
              
             <td>  
              <a href="<?= base_url() ?>Chat/conversation/<?= base64_encode($row['id']) ?>" title="Send Message" class="btn btn-xs btn-success"><i class="fa fa-comments"></i></a>
              <?php
              if($row['is_pro_user'] == 1)
            {
              ?>
            ...
            ?>
             ...
             <!--  <?php 
              ...
              <a href="javascript:;" title="verify" class="btn btn-xs btn-default" onclick="verify('<?=$row['id']?>','1');" > <B style="color:#090;size:40px;">Verify</B></a>
              ...
              <a href="javascript:;" title="unverify" class="btn btn-xs btn-default" onclick="verify('<?=$row['id']?>','0');" ><B style="color:#F00;">Unverify</B></a>
