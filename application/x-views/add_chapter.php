                                      ...
                                      <div class="col-sm-12">
                                        <div class="col-sm-6">
                                          ...
                                          <div class="row" style="margin-top: 15px">
                                            <div class="col-sm-12">
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="all_slow" style="display:none;" class="audio_required" /> 
                                                ...
                                                <input type="hidden" name="old_audio[]" id="all_slow_old_audio" value="<?php echo $ear_chapter_detail[0]['audio']; ?>">
                                              </div>
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="all_medium" style="display:none;" class="audio_required"/> 
                                                ...
                                                <input type="hidden" name="old_audio[]" id="all_medium_old_audio" value="<?php echo $ear_chapter_detail[1]['audio']; ?>">
                                              </div>
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="all_fast" style="display:none;" class="audio_required"/> 
                                                ...
                                                <input type="hidden" name="old_audio[]" id="all_fast_old_audio" value="<?php echo $ear_chapter_detail[2]['audio']; ?>">
                                              </div>
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="all_extreme" style="display:none;" class="audio_required"/> 
                                                ...
                                                <input type="hidden" name="old_audio[]" id="all_extreme_old_audio" value="<?php echo $ear_chapter_detail[3]['audio']; ?>">
                                              </div>
                                            </div>
                                          </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                          ...
                                          <div class="row" style="margin-top: 15px">
                                            <div class="col-sm-12">
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="four_slow" style="display:none;" class="audio_required"/> 
                                                <input type="button" class="btn btn-secondary" onClick="four_slow.click();" value="Slow" style="width: 100%;"/>
                                                <span id="four_slow_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[4]['audio'], 10, ' ') ; ?></span>
                                                <input type="hidden" name="old_audio[]" id="four_slow_old_audio" value="<?php echo $ear_chapter_detail[4]['audio']; ?>">
                                              </div>
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="four_medium" style="display:none;" class="audio_required"/> 
                                                <input type="button" class="btn btn-secondary" onClick="four_medium.click();" value="Medium" style="width: 100%;"/>
                                                <span id="four_medium_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[5]['audio'], 10, ' ') ; ?></span>
                                                <input type="hidden" name="old_audio[]" id="four_medium_old_audio" value="<?php echo $ear_chapter_detail[5]['audio']; ?>">
                                              </div>
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="four_fast" style="display:none;" class="audio_required"/> 
                                                <input type="button" class="btn btn-secondary" onClick="four_fast.click();" value="Fast" style="width: 100%;"/>
                                                <span id="four_fast_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[6]['audio'], 10, ' ') ; ?></span>
                                                <input type="hidden" name="old_audio[]" id="four_fast_old_audio" value="<?php echo $ear_chapter_detail[6]['audio']; ?>">
                                              </div>
                                              <div class="col-sm-3">
                                                <input type="file" name="audio[]" id="four_extreme" style="display:none;" class="audio_required"/> 
                                                <input type="button" class="btn btn-secondary" onClick="four_extreme.click();" value="Extreme" style="width: 100%;"/>
                                                <span id="four_extreme_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[7]['audio'], 10, ' ') ; ?></span>
                                                <input type="hidden" name="old_audio[]" id="four_extreme_old_audio" value="<?php echo $ear_chapter_detail[7]['audio']; ?>">
                                              </div>
                                            </div>
                                          </div>                                        
                                        </div>
                                    ...
                                    <div class="row" id="major" style="margin-bottom: 15px; display: none;">
                                      <div class="col-sm-12" style="margin-left: 10%;">
                                        <div class="col-sm-1">
                                          ...
                                          <span id="five_point_five_minus_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[8]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="five_point_five_minus_major_old_audio" value="<?php echo $ear_chapter_detail[8]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="six_point_five_minus_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[9]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="six_point_five_minus_major_old_audio" value="<?php echo $ear_chapter_detail[9]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="one_point_five_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[10]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="one_point_five_major_old_audio" value="<?php echo $ear_chapter_detail[10]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="two_point_five_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[11]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="two_point_five_major_old_audio" value="<?php echo $ear_chapter_detail[11]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="four_point_five_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[12]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="four_point_five_major_old_audio" value="<?php echo $ear_chapter_detail[12]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="five_point_five_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[13]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="five_point_five_major_old_audio" value="<?php echo $ear_chapter_detail[13]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="six_point_five_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[14]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="six_point_five_major_old_audio" value="<?php echo $ear_chapter_detail[14]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="one_point_five_plus_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[15]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="one_point_five_plus_major_old_audio" value="<?php echo $ear_chapter_detail[15]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="two_point_five_plus_major_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[16]['audio'], 10, ' ') ;?></span>
                                          <input type="hidden" class="edit_major_audio_file" id="two_point_five_plus_major_old_audio" value="<?php echo $ear_chapter_detail[16]['audio']; ?>">
                                        </div>
                                      </div>
                                    </div>
                                    <!-- Major End -->
                                    ...
                                    <div class="row" id="minor" style="margin-bottom: 15px; display: none;">
                                      <div class="col-sm-12" style="margin-left: 10%;">
                                        <div class="col-sm-1">
                                          ...
                                          <span id="six_point_five_minus_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[8]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="six_point_five_minus_minor_old_audio" value="<?php echo $ear_chapter_detail[8]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="seven_point_five_minus_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[9]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="seven_point_five_minus_minor_old_audio" value="<?php echo $ear_chapter_detail[9]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="one_point_five_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[10]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="one_point_five_minor_old_audio" value="<?php echo $ear_chapter_detail[10]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="three_point_five_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[11]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="three_point_five_minor_old_audio" value="<?php echo $ear_chapter_detail[11]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="four_point_five_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[12]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="four_point_five_minor_old_audio" value="<?php echo $ear_chapter_detail[12]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="six_point_five_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[13]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="six_point_five_minor_old_audio" value="<?php echo $ear_chapter_detail[13]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="seven_point_five_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[14]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="seven_point_five_minor_old_audio" value="<?php echo $ear_chapter_detail[14]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="one_point_five_plus_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[15]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="one_point_five_plus_minor_old_audio" value="<?php echo $ear_chapter_detail[15]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1">
                                          ...
                                          <span id="three_point_five_plus_minor_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[16]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" class="edit_minor_audio_file" id="three_point_five_plus_minor_old_audio" value="<?php echo $ear_chapter_detail[16]['audio']; ?>">
                                        </div>
                                      </div>
                                    </div>
                                    <!-- Minor End -->
                                    <div class="row" style="margin-bottom: 15px">
                                      <div class="col-sm-12" style="margin-left: 1%;">
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="five_minus_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[17]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="five_minus_old_audio" value="<?php echo $ear_chapter_detail[17]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="six_minus_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[18]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="six_minus_old_audio" value="<?php echo $ear_chapter_detail[18]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="seven_minus_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[19]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="seven_minus_old_audio" value="<?php echo $ear_chapter_detail[19]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="one_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[20]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="one_old_audio" value="<?php echo $ear_chapter_detail[20]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="two_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[21]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="two_old_audio" value="<?php echo $ear_chapter_detail[21]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="three_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[22]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="three_old_audio" value="<?php echo $ear_chapter_detail[22]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="four_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[23]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="four_old_audio" value="<?php echo $ear_chapter_detail[23]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="five_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[24]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="five_old_audio" value="<?php echo $ear_chapter_detail[24]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="six_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[25]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="six_old_audio" value="<?php echo $ear_chapter_detail[25]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="seven_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[26]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="seven_old_audio" value="<?php echo $ear_chapter_detail[26]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="one_plus_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[27]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="one_plus_old_audio" value="<?php echo $ear_chapter_detail[27]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="two_plus_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[28]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="two_plus_old_audio" value="<?php echo $ear_chapter_detail[28]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="three_plus_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[29]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="three_plus_old_audio" value="<?php echo $ear_chapter_detail[29]['audio']; ?>">
                                        </div>
                                        <div class="col-sm-1" style="width: 7%;">
                                          ...
                                          <span id="four_plus_filename" onclick="manage_add_edit_audio_Files(this)" style="cursor: pointer;"><?php echo chunk_split($ear_chapter_detail[30]['audio'], 10, ' ') ; ?></span>
                                          <input type="hidden" name="old_audio[]" id="four_plus_old_audio" value="<?php echo $ear_chapter_detail[30]['audio']; ?>">
                                        </div>
