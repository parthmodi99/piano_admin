                                  ...
                                  <div class="col-sm-12">
                                      <div class="col-sm-6">
                                        <video id="video1" controls width="400" >
                                            <source src="http://18.235.99.234/piano/APIs/uploads/chapter/${element.media}" type="video/mp4">
                                        </video>
                                      </div>
                                  </div>
                              </div>
                      ...
                      <div class="section droppable ui-sortable" id="section_html">
                          <div id="sec_1" class="addpianospace draggable" style="border: 2px solid #000000;padding: 10px;margin: 15px;">
                              <div class="row">
                                  <div class="col-sm-12">
                                      <div class="col-sm-6">
                                          <img src="http://18.235.99.234/piano/APIs/uploads/chapter/${element.media}"
